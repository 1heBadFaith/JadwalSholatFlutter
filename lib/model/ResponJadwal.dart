import 'package:jadwal_sholat_flutter/model/today_weather.dart';
import 'package:jadwal_sholat_flutter/model/items.dart';
...
class ResponJadwal {
  ...
  String status_description;
	...
	Map<String, dynamic> toJson() {
		...
		data['today_weather'] = today_weather == null ? null : today_weather.toJson();
		data['link'] = link;
